...
Celui-ci démarre du Néolithique (-5000 -4000 avant JC) pour aller jusqu'à nos jours. Cela m'a beaucoup impressionné car étonnement il y a beaucoup de sites Néolithique relativement bien conservés et surtout bien valorisés.
...
Voici la liste des lieux inclus dans le site UNESCO :

- Les Temples Ġgantija - parmi les plus anciens monuments mégalithiques du monde
- Le Temple Skorba - révélant des phases d'occupation remontant à 5000 av. J.-C.
- Ta' Ħaġrat - composé de deux temples adjacents
- Les Temples Ħaġar Qim - connus pour leurs alignements astronomiques
- Les Temples Tarxien - les plus complexes architecturalement
...
|||
|-|-|
|Titre (fr)|Temples mégalithiques de Malte|
|Ancien titre|Temple de Ġgantija|
|Id|132bis|
|Date d'enregistrement|1980|
|Localisation de la stelle|À l'entrée du musée du site de Ġgantija sur l'île de Gozo|
|Visité le|2015-06-06|
|Interet|Haute|
 ...
 * [Sur le site Wikipédia (fr)](https://fr.wikipedia.org/wiki/Temples_m%C3%A9galithiques_de_Malte)
 * [Sur le site de l'UNESCO](http://whc.unesco.org/fr/list/132bis)
