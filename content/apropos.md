...
* **Agentic / GenAI Developer Tooling — Aeronautics Industry**
  * Won a deal to provide an Agentic and GenAI-powered code development tooling solution for a team (100 pax), with an architecture addressable up to **3,000 users**, operating under highly regulated constraints
...
I have go a [GitHub repo](https://github.com/gautric) for several projects I like to share, I'm [Apache contributor ](http://people.apache.org/unlistedclas.html) and [HomeAssistant](https://www.home-assistant.io/developers/credits/) :

Here is some of my modest contributions :

* [ServiceMix SM-826](https://issues.apache.org/jira/browse/SM-826)
* [eh-cache EHC-431](https://jira.terracotta.org/jira/browse/EHC-431)
* [JBoss/Picketbox SECURITY-875](https://issues.jboss.org/browse/SECURITY-875)
* [OpenSC](https://github.com/OpenSC/libp11/issues/15)
* [Yubico JAAS](https://github.com/Yubico/yubico-java-client/pull/10)
* [Openshift/spring-eap6-quickstart](https://github.com/openshift/spring-eap6-quickstart/pull/3)
* [CAMEL-9337](https://issues.apache.org/jira/browse/CAMEL-9337) -->
